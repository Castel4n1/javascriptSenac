    ...
    <div class="container">
        <h1>ATIVIDADE 1 JS</h1>
            ...
            <p class="mt-4 text-center">
                ...
                <span class="btn btn-success"> Limpar</span>
            </p>
        </div>
        <!--  CAIXA DE TEXTO -->       
...
<script>
        ...
        function contador(){
            ...
            $('#caixa').empty().append(textoFinal);            

            //ternario (CONDIÇÃO ? RESULTADO TRUE : RESULTADO FALSE)            
            
            $('#contador').empty().append( ( (limite - tamanho) < 0 ? '0' : (limite - tamanho) ) );
        ...
        $('#btn1').click(function (e) { 
            e.preventDefault();
            $('#caixa').append("<strong> Abacaxi, </strong>");
            contador();
        ...
        $('#btn2').click(function (e) { 
            e.preventDefault();
        $('#caixa').append("<strong> Batata, </strong>");
        contador();
        ...
        $('#caixa').append("<strong> Carvão, </strong>");
        contador();
        ...
        $('#caixa').append("<strong> Dados, </strong>");
        contador();
        ...
        $('#caixa').append("<strong> Facas, </strong>");
        contador();
        ...
        $('#caixa').append("<strong> Garfos, </strong>");
        contador();
        ...
        $('#caixa').append("<strong> Hidrante, </strong>");
        contador();
        ...
        $('#caixa').append("<strong> Individual. </strong>");
        contador();
